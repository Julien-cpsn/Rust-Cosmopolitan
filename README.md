...
2. Follow Cosmopolitan build steps (`cd cosmopolitan && make`)
3. Set the `COSMO` env variable to point foward your Cosmopolitan directory (that contains `.cosmocc`, `ape`, `o`, ... directories) (You may have to edit cosmo version from the path at line 15 in `gcc-linker-wrapper.bash`)
